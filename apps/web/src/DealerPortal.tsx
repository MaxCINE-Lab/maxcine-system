...
import { AccountMenu, SystemNavigation, displayRoleText, employeeNumberForUser } from './systemNavigation';
...
function OrderForm({ user, route, editId }: { user: SessionUser; route: string; editId?: string }) {
  ...
  const photoWatermarkLines = ['山东省服务中心', `工号 ${employeeNumberForUser(user) ?? '9353'}`];
